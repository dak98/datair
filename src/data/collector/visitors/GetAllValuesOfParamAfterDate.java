...
public class GetAllValuesOfParamAfterDate extends Visitor {
     ...
     * @return List of {@link data.source.SensorData.Values} of given parameter after given dates.
     */
    @Override
    public Object visit(AirDataCollector airDataCollector, String[] args, Source dataSource) {
        ...
        for (SensorData sensorData : sensorDataList) {
            ...
            for (SensorData.Values value : valuesList) {
                if (!value.getValue().equals("null") && datesComparator.isLaterDate(value.getDate(), args[1])) {
